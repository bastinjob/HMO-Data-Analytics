...
date: "2022-11-17"
#outliers from both bmi and cost removed
---
...
#(age=c(37),bmi=c(27.74),children=c(3),smoker=as.factor(c(0)),exercise=as.factor(c(0)),hypertension=as.factor(c(0)),gender=as.factor(c(0)))
